...
class ShortcutAdapter internal constructor(private val mValues: List<ShortcutItem>, private val listener: OnShortcutAdapterListener) : androidx.recyclerview.widget.RecyclerView.Adapter<ShortcutAdapter.ViewHolder>() {
    @NonNull

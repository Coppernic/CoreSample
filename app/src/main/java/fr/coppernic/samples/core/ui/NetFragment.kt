...
class NetFragment : androidx.fragment.app.Fragment(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(viewBinding) {
            ...
            edtMask.addTextChangedListener(
                RegexTextWatcher(
            ...
            edtGateway.addTextChangedListener(
                RegexTextWatcher(
                    regex = android.util.Patterns.IP_ADDRESS.toRegex(),
            ...
            edtDns1.addTextChangedListener(
                RegexTextWatcher(
                    regex = android.util.Patterns.IP_ADDRESS.toRegex(),
            ...
            edtDns2.addTextChangedListener(
                RegexTextWatcher(
                    regex = android.util.Patterns.IP_ADDRESS.toRegex(),
            ...
            btnIp.setOnClickListener {
                if (presenter.isValidIp(edtIp.text.toString()) &&
                    ...
                    try {
                        ...
                        StaticIpConfig.configureStaticIp(
                            view.context,
                            edtIp.text.toString(),
                            prefix,
